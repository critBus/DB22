...
public class LibroDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public LibroDetachedCriteria() {
		super(clases.Libro.class, clases.LibroCriteria.class);
		edicion = new IntegerExpression("edicion", this.getDetachedCriteria());
	}
	
	public LibroDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, clases.LibroCriteria.class);
		edicion = new IntegerExpression("edicion", this.getDetachedCriteria());
	}
